...
alias lp='git add . && git commit -m "chore: update learning repo" && git push' # because I CANNOT keep writing commit messages for every single change in a goddamn learning repo 
